...
import base64
from edados.formularios.form_questao_demografica_e_notas import MeuFormulario
...
def view_quest_demo_notas(request):
    ...
    if request.method == 'GET':
        ...
        'realizando o comparativo entre: Questão Demográfica e Desempenho no ENEM', size=16)
