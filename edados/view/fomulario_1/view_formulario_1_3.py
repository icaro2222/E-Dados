...
import base64
from edados.formularios.formulario_1.formulario_1_3 import Formulario
...
def formulario_3(request):
    ...
    if request.method == 'GET':        
        ...
        return render(request, 'base/formulario_1/quest_formulario_3.html', context=context)
    else:
    ...
    return render(request, 'base/formulario_1/relatorio_formulario_3.html', context=context)
