...
-- Criando INDEX para banco de 2019 
Aqui está a versão formatada e bonita do seu comando SQL:

CREATE INDEX index_enem_2019 ON enem_2019_1 (
    "IN_BAIXA_VISAO",
    "IN_CEGUEIRA",
    "TP_PRESENCA_CH",
    "NU_ANO",
...
FROM '/home/icaro/documentos/microdados/microdados_enem_2018/MICRODADOS_ENEM_2018.csv' 
WITH DELIMITER ';' CSV HEADER ENCODING 'iso-8859-1';

UPDATE enem_2018
SET "TP_ESTADO_CIVIL" = CASE "TP_ESTADO_CIVIL"
                        WHEN '0' THEN '1'
                        WHEN '1' THEN '2'
                        WHEN '2' THEN '3'
                        WHEN '3' THEN '4'
