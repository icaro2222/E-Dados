...
from edados.formularios.base import questionario_adm_escola, questionario_ano_de_conclusao, questionario_amostra, questionario_recursos, questionario_localizacao_da_escola, questionario_estado, questionario_de_nacionalidade,questionario_sexo, questionario_de_escola, questionario_cor, questionario_estado_civil, questionario_de_deficiencia
