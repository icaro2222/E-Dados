...
def questionario_prova_ciencia_humana(Form):
    ...
    prova_cores=forms.ChoiceField(
        label="Prova de Ciências Humanas:", choices=choices_prova, required=False)
    return prova_cores


def questionario_prova_linguagens_codigos(Form):
